...
Basic.prototype = {
	...
	,setup: function() {
		this._view = new hxDaedalus_view_KSimpleView();
	...
	,render: function(framebuffer) {
		...
		g2.begin();
		g2.clear(kha__$Color_Color_$Impl_$._new(-3355444));
		g2.set_color(-1);
		g2.set_opacity(1.);
		this._view.drawMesh(g2,this._mesh);
		g2.end();
...
BitmapPathfinding.__name__ = true;
BitmapPathfinding.prototype = {
	...
	,setup: function() {
		this.imgBW = kha_Assets.images.galapagosBW;
		this.imgColor = kha_Assets.images.galapagosColor;
		var this1 = new hxPixels__$Pixels_PixelsData(this.imgBW.get_width(),this.imgBW.get_height(),true);
		var pixels = this1;
		var _g1 = 0;
		...
		while(_g1 < _g) {
			...
			while(_g3 < _g2) {
				var x = _g3++;
				hxPixels__$Pixels_Pixels_$Impl_$.setPixel(pixels,x,y,this.imgBW.at(x,y));
			}
		}
...
Main.main = function() {
	...
	Main.resize();
	kha_System.init({ title : "hxDaedalus BitmapPathfinding", width : 1024, height : 768, samplesPerPixel : 4},function() {
...
Pathfinding.prototype = {
	...
	,setup: function() {
		...
		while(_g < 50) {
			var i = _g++;
			object = new hxDaedalus_data_Object();
			shapeCoords = [];
...
$hxClasses["PathfindingMaze"] = PathfindingMaze;
PathfindingMaze.__name__ = true;
PathfindingMaze.prototype = {
	...
	,loadAll: function() {
		...
		kha_Scheduler.addTimeTask($bind(this,this.update),0,0.0166666666666666664);
		kha_input_Mouse.get().notify($bind(this,this.onMouseDown),$bind(this,this.onMouseUp),$bind(this,this.onMouseMove),null,null);
		kha_input_Keyboard.get().notify(null,null,$bind(this,this.pressListener));
	}
...
var hxDaedalus_view_KSimpleView = $hx_exports["hxDaedalus"]["view"]["KSimpleView"] = function() {
...
$hxClasses["hxDaedalus.view.KSimpleView"] = hxDaedalus_view_KSimpleView;
hxDaedalus_view_KSimpleView.__name__ = true;
hxDaedalus_view_KSimpleView.prototype = {
	edgesColor: null
	,edgesWidth: null
	,edgesAlpha: null
	...
	,circle: function(g2,p,radius,color,alpha) {
		...
		g2.set_color(color);
		kha_graphics2_GraphicsExtension.fillCircle(g2,p.x,p.y,radius);
	}
	...
	,drawEntity: function(g2,entity) {
		...
		g2.set_color(color);
		kha_graphics2_GraphicsExtension.fillCircle(g2,entity.x,entity.y,radius);
	}
	...
	,__class__: hxDaedalus_view_KSimpleView
};
...
kha__$Assets_ImageList.prototype = {
	...
	,galapagosBWLoad: function(done) {
		kha_Assets.loadImage("galapagosBW",function(image) {
			done();
		});
	}
	...
	,galapagosColorLoad: function(done) {
		kha_Assets.loadImage("galapagosColor",function(image) {
			done();
		});
	}
...
$hxClasses["wings.jsCanvas.BasicCanvas"] = wings_jsCanvas_BasicCanvas;
...
$hxClasses["wings.jsCanvas.CanvasHeader"] = wings_jsCanvas_CanvasHeader;
...
$hxClasses["wings.jsCanvas.SimpleDrawingContext"] = wings_jsCanvas_SimpleDrawingContext;
